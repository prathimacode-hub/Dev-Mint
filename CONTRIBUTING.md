...
* Step 2: Add an upstream link to the main branch in your cloned repo
    ```
    git remote add upstream https://github.com/prathimacode-hub/Dev-Mint.git
    ```
...
4. Participants/contributors can also **open their issues** using [issue_template](https://github.com/prathimacode-hub/Dev-Mint/tree/main/.github/issue_template),
...
1. Please fill the **[PR Template](https://github.com/prathimacode-hub/Dev-Mint/blob/main/.github/pullrequest_template.md)** properly while making a Pull Request.
